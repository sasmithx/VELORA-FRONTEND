...
export default function ProfileScreen() {
  ...
  const bookmarks = useSelector(
    (state: RootState) => state.newsReducer.bookmarked
  );
  ...
  return (
    <SafeAreaView className="flex-1 bg-background">
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        <LinearGradient
          colors={["rgba(14, 165, 233, 0.4)", "rgba(15, 23, 42, 0)"]}
          start={{ x: 0.5, y: 0 }}
          end={{ x: 0.5, y: 1 }}
        ...
        >
          <View className="bg-background-card/40 px-5 py-2 rounded-full border border-border/20">
